...
export const AGENT_REGISTRY: AgentDef[] = [
  ...
  },
  {
    ...
    models: ['gpt-4o-mini', 'gpt-4o', 'o3-mini', 'o1', 'gpt-4.1'],
    needsApiKey: true,
    needsEndpoint: false,
  ...
  {
    id: 'byok-mimo',
    displayName: 'Mimo (Xiaomi BYOK)',
    category: 'cloud-api',
    kind: 'http',
    description: 'Xiaomi Mimo API (Singapore endpoint) — bring your own key',
    iconName: 'Sparkles',
    defaultModel: 'mimo-v1',
    models: ['mimo-v1', 'mimo-v1-chat', 'mimo-v1-flash', 'gpt-4o-mini', 'gpt-4o'],
    allowsCustomModel: true,
    needsApiKey: true,
    needsEndpoint: false,
    protocol: 'openai',
    defaultEndpoint: 'https://token-plan-sgp.xiaomimimo.com/v1',
    envKeyNames: ['MIMO_API_KEY', 'OPENAI_API_KEY'],
  },
  {
    id: 'byok-deepseek',
    ...
    category: 'cloud-api',
    kind: 'http',
    description: 'DeepSeek API (V3 / R1 reasoning) — bring your own key',
    iconName: 'Sparkles',
